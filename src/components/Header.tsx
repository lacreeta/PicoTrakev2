...
// 🧠 Props que solo se usarán en /map
  ...
  <>
    ...
    {isDropdownOpen && (
      <div className="absolute right-0 mt-2 w-[140px] bg-white dark:bg-gray-700 shadow-md rounded-md py-2">
        <Link className="block px-4 py-2 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600" to="/profile">
          {t("myProfile")}
        </Link>
        <Link className="block px-4 py-2 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600" to="/userSettings">
          {t("settings")}
        </Link>
        <button
          onClick={() => {

  ...
  return (
    <div className="flex items-center w-full max-w-full">
      <input
        ...
        className={`p-2 sm:p-2 h-[40px] sm:h-[40px] w-full rounded-l-[15px] border focus:outline-none focus:ring-2
          ${darkMode
      ...
      <button
        type="button"
        className={`p-2 sm:p-2 h-[40px] sm:h-[40px] shadow-md rounded-r-[15px] font-bold text-sm flex items-center justify-center
          ${darkMode
